...
# is now produced locally by LEFA and no longer implies a Sovereign Hub runtime hop.
...
def _observe_alpaca_account() -> dict[str, Any]:
    ...
    No cross-repository service is involved. Missing configuration fails closed;
    provider errors remain backend details and never expose credentials.
    """
